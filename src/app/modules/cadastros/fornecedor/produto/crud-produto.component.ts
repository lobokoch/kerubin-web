import { FotoImage } from './../foto/foto.model';
/**********************************************************************************************
...
export class ProdutoComponent implements OnInit {
  ...
  deleteProdutoFotosItem(foto: FotoImage) {
  ...
  editProdutoFotosItem(foto: FotoImage) {
    if (foto && foto.id) {
      this.fotoSelected = new FotoImage(foto.id, foto.descricao);
  ...
  uploadProdutoFoto(fotoFile: File) {
    ...
    .then((foto) => {
      ...
      this.produto.fotos.push(new Foto(foto.id, foto.descricao));
  ...
  dragStart(event, foto: FotoImage) {
