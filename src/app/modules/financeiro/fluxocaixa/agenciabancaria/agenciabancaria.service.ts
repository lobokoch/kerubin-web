...
export class AgenciaBancariaService {
	...
	create(agenciaBancaria: AgenciaBancaria): Promise<AgenciaBancaria> {
		...
		this.analitycs.sendEvent('financeiro.fluxo_caixa.AgenciaBancaria', 'create', 'create AgenciaBancaria');
	...
	update(agenciaBancaria: AgenciaBancaria): Promise<AgenciaBancaria> {
	    const headers = this.getHeaders();
		this.analitycs.sendEvent('financeiro.fluxo_caixa.AgenciaBancaria', 'update', 'update AgenciaBancaria');
	...
	delete(id: string): Promise<void> {
		this.analitycs.sendEvent('financeiro.fluxo_caixa.AgenciaBancaria', 'delete', 'delete AgenciaBancaria');
	...
	retrieve(id: string): Promise<AgenciaBancaria> {
		this.analitycs.sendEvent('financeiro.fluxo_caixa.AgenciaBancaria', 'retrieve', 'retrieve AgenciaBancaria');
	    const headers = this.getHeaders();
	...
	autoComplete(query: string): Promise<AgenciaBancariaAutoComplete[]> {
		...
		this.analitycs.sendEvent('financeiro.fluxo_caixa.AgenciaBancaria', 'autoComplete', JSON.stringify(params));
	...
	agenciaBancariaList(agenciaBancariaListFilter: AgenciaBancariaListFilter): Promise<any> {
		...
		this.analitycs.sendEvent('financeiro.fluxo_caixa.AgenciaBancaria', 'agenciaBancariaList', JSON.stringify(params));
	...
	getTotaisfilterAgenciaBancaria(filter: AgenciaBancariarListFilter): Promise<TotaisfilterAgenciaBancaria> {
		...
		this.analitycs.sendEvent('financeiro.fluxo_caixa.AgenciaBancaria', 'getTotaisfilterAgenciaBancaria', JSON.stringify(params));
