...
export class ContaBancariaService {
	...
	create(contaBancaria: ContaBancaria): Promise<ContaBancaria> {
		...
		this.analitycs.sendEvent('financeiro.contas_pagar.ContaBancaria', 'create', 'create ContaBancaria');
	...
	update(contaBancaria: ContaBancaria): Promise<ContaBancaria> {
	    const headers = this.getHeaders();
		this.analitycs.sendEvent('financeiro.contas_pagar.ContaBancaria', 'update', 'update ContaBancaria');
	...
	delete(id: string): Promise<void> {
		this.analitycs.sendEvent('financeiro.contas_pagar.ContaBancaria', 'delete', 'delete ContaBancaria');
	...
	retrieve(id: string): Promise<ContaBancaria> {
		this.analitycs.sendEvent('financeiro.contas_pagar.ContaBancaria', 'retrieve', 'retrieve ContaBancaria');
	    const headers = this.getHeaders();
	...
	autoComplete(query: string): Promise<ContaBancariaAutoComplete[]> {
		...
		this.analitycs.sendEvent('financeiro.contas_pagar.ContaBancaria', 'autoComplete', JSON.stringify(params));
	...
	agenciaBancariaAgenciaAutoComplete(query: string): Promise<AgenciaBancariaAutoComplete[]> {
	    ...
	    let params = new HttpParams();
	    params = params.set('query', query);
		this.analitycs.sendEvent('financeiro.contas_pagar.AgenciaBancaria', 'agenciaBancariaAgenciaAutoComplete', JSON.stringify(params));
	...
	contaBancariaNumeroContaAutoComplete(query: string): Promise<any> {
	    ...
	    let params = new HttpParams();
	    params = params.set('query', query);
		this.analitycs.sendEvent('financeiro.contas_pagar.ContaBancaria', 'contaBancariaNumeroContaAutoComplete', JSON.stringify(params));
	...
	contaBancariaList(contaBancariaListFilter: ContaBancariaListFilter): Promise<any> {
		...
		this.analitycs.sendEvent('financeiro.contas_pagar.ContaBancaria', 'contaBancariaList', JSON.stringify(params));
	...
	getTotaisfilterContaBancaria(filter: ContaBancariarListFilter): Promise<TotaisfilterContaBancaria> {
		...
		this.analitycs.sendEvent('financeiro.contas_pagar.ContaBancaria', 'getTotaisfilterContaBancaria', JSON.stringify(params));
