...
export class FornecedorService {
	...
	create(fornecedor: Fornecedor): Promise<Fornecedor> {
		...
		this.analitycs.sendEvent('financeiro.contas_pagar.Fornecedor', 'create', 'create Fornecedor');
	...
	update(fornecedor: Fornecedor): Promise<Fornecedor> {
	    const headers = this.getHeaders();
		this.analitycs.sendEvent('financeiro.contas_pagar.Fornecedor', 'update', 'update Fornecedor');
	...
	delete(id: string): Promise<void> {
		this.analitycs.sendEvent('financeiro.contas_pagar.Fornecedor', 'delete', 'delete Fornecedor');
	...
	retrieve(id: string): Promise<Fornecedor> {
		this.analitycs.sendEvent('financeiro.contas_pagar.Fornecedor', 'retrieve', 'retrieve Fornecedor');
	    const headers = this.getHeaders();
	...
	autoComplete(query: string): Promise<FornecedorAutoComplete[]> {
		...
		this.analitycs.sendEvent('financeiro.contas_pagar.Fornecedor', 'autoComplete', JSON.stringify(params));
	...
	fornecedorNomeAutoComplete(query: string): Promise<any> {
	    ...
	    let params = new HttpParams();
	    params = params.set('query', query);
		this.analitycs.sendEvent('financeiro.contas_pagar.Fornecedor', 'fornecedorNomeAutoComplete', JSON.stringify(params));
	...
	fornecedorList(fornecedorListFilter: FornecedorListFilter): Promise<any> {
		...
		this.analitycs.sendEvent('financeiro.contas_pagar.Fornecedor', 'fornecedorList', JSON.stringify(params));
	...
	getTotaisfilterFornecedor(filter: FornecedorrListFilter): Promise<TotaisfilterFornecedor> {
		...
		this.analitycs.sendEvent('financeiro.contas_pagar.Fornecedor', 'getTotaisfilterFornecedor', JSON.stringify(params));
