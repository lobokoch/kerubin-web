...
export class CartaoCreditoService {
	...
	create(cartaoCredito: CartaoCredito): Promise<CartaoCredito> {
		...
		this.analitycs.sendEvent('financeiro.contas_receber.CartaoCredito', 'create', 'create CartaoCredito');
	...
	update(cartaoCredito: CartaoCredito): Promise<CartaoCredito> {
	    const headers = this.getHeaders();
		this.analitycs.sendEvent('financeiro.contas_receber.CartaoCredito', 'update', 'update CartaoCredito');
	...
	delete(id: string): Promise<void> {
		this.analitycs.sendEvent('financeiro.contas_receber.CartaoCredito', 'delete', 'delete CartaoCredito');
	...
	retrieve(id: string): Promise<CartaoCredito> {
		this.analitycs.sendEvent('financeiro.contas_receber.CartaoCredito', 'retrieve', 'retrieve CartaoCredito');
	    const headers = this.getHeaders();
	...
	autoComplete(query: string): Promise<CartaoCreditoAutoComplete[]> {
		...
		this.analitycs.sendEvent('financeiro.contas_receber.CartaoCredito', 'autoComplete', JSON.stringify(params));
	...
	bandeiraCartaoBandeiraCartaoAutoComplete(query: string): Promise<BandeiraCartaoAutoComplete[]> {
	    ...
	    let params = new HttpParams();
	    params = params.set('query', query);
		this.analitycs.sendEvent('financeiro.contas_receber.BandeiraCartao', 'bandeiraCartaoBandeiraCartaoAutoComplete', JSON.stringify(params));
	...
	cartaoCreditoList(cartaoCreditoListFilter: CartaoCreditoListFilter): Promise<any> {
		...
		this.analitycs.sendEvent('financeiro.contas_receber.CartaoCredito', 'cartaoCreditoList', JSON.stringify(params));
	...
	getTotaisfilterCartaoCredito(filter: CartaoCreditorListFilter): Promise<TotaisfilterCartaoCredito> {
		...
		this.analitycs.sendEvent('financeiro.contas_receber.CartaoCredito', 'getTotaisfilterCartaoCredito', JSON.stringify(params));
